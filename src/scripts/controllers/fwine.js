import fwineView from '../views/fwine.art'
const fwineModel = require('../models/clearance')
const fwineListView = require('../views/fwine_list.art')
...
class Fwine{
    ...
    async render(){
        ...
        let result=await fwineModel.get({
            state1:'dynamic',
