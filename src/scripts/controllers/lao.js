const laoView = require('../views/lao.art')
const laoModel = require('../models/clearance')
const laoListView = require('../views/lao_list.art')
...
class Lao{
    ...
    async renderer(list0){
        ...
        let laoListHtml = laoListView({
            list0
        })
        await  $('.main_lao .banner ul').eq(this.count).html(laoListHtml)
